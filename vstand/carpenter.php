        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                    <li class="active"><a href="carpenter.php">Furniture Reapir</a></li>
                    <li><a href="carpenter1.php">Furniture Assembly</a></li>
                            ...
                            if ($result) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    echo  "
                                        ...
                                        <td>  <button type='button' class='btn btn-primary form-control' data-toggle='modal' data-target='#".$row['id'] ."'><b>Quote
                                        </b></button> </td>
                                        ...
                                        <div class='modal-dialog modal-sm'>
                                            <div class='modal-content'>
                                                ...
                                                <div class='modal-body'>
                                                    <form method='POST' action='funbook.php'>
