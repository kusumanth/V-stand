        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="electrician.php">Electrician Installation</a></li>
                    <li><a href="electrician1.php">Electrician Repair</a></li>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="pre-scrollable" style=" max-height: 75vh;">
                                <table class="table table-responsive table-hover">
                                    ...
                                    $sql = "SELECT * FROM  electricial_installation  ";
                                            ...
                                            <div class='modal-dialog modal-sm'>
                                                <div class='modal-content'>
                                                    ...
                                                    <div class='modal-body'>
                                                        <form method='POST' action='electrician_installation_quote.php '>
